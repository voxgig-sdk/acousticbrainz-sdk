...
func registerSDKWords(r *eng.Registry, client *sdk.AcousticbrainzSDK) {
...
func runOp(client *sdk.AcousticbrainzSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
