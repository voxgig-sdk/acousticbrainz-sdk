...
AQL-driven CLI and REPL for the Acousticbrainz SDK. Positional arguments are
...
./acousticbrainz-cli list high_level
./acousticbrainz-cli load 1 high_level
./acousticbrainz-cli load '{id:1}' high_level
