...
func (sdk *AcousticbrainzSDK) OptionsMap() map[string]any {
...
func (sdk *AcousticbrainzSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AcousticbrainzSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AcousticbrainzSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AcousticbrainzSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AcousticbrainzSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AcousticbrainzSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AcousticbrainzSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AcousticbrainzSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AcousticbrainzSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AcousticbrainzSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AcousticbrainzSDK {
	...
	sdk := NewAcousticbrainzSDK(sdkopts)
	sdk.Mode = "test"
