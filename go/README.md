...
The Golang SDK for the Acousticbrainz API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/acousticbrainz-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/acousticbrainz-sdk=../path/to/github.com/voxgig-sdk/acousticbrainz-sdk
```
...
```
github.com/voxgig-sdk/acousticbrainz-sdk/
...
The root package (`github.com/voxgig-sdk/acousticbrainz-sdk`) re-exports everything needed
