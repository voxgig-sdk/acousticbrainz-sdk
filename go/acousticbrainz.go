...
// instead of `sdk.NewAcousticbrainzSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AcousticbrainzSDK  { return NewAcousticbrainzSDK(nil) }
func Test() *AcousticbrainzSDK { return TestSDK(nil, nil) }
