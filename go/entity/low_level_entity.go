...
func NewLowLevelEntity(client *core.AcousticbrainzSDK, entopts map[string]any) *LowLevelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LowLevelEntity) GetName() string { return e.name }
...
func (e *LowLevelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LowLevelEntity) Deleted() bool {
	return e.deleted
}


func (e *LowLevelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLowLevelEntity(e.client, opts)
}

func (e *LowLevelEntity) Data(args ...any) any {
...
func (e *LowLevelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LowLevel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LowLevelEntity) DataTyped(data ...LowLevel) LowLevel {
	if len(data) > 0 {
		return typedFrom[LowLevel](e.Data(asMap(data[0])))
	}
	return typedFrom[LowLevel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LowLevel (all fields
// optional at the wire level).
func (e *LowLevelEntity) MatchTyped(match ...LowLevel) LowLevel {
	if len(match) > 0 {
		return typedFrom[LowLevel](e.Match(asMap(match[0])))
	}
	return typedFrom[LowLevel](e.Match())
}
...
func (e *LowLevelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LowLevelEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LowLevelLoadMatch and returns an LowLevel. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LowLevelEntity) LoadTyped(reqmatch LowLevelLoadMatch, ctrl map[string]any) (LowLevel, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LowLevel{}, err
	}
	return typedFrom[LowLevel](res), nil
}



func (e *LowLevelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LowLevelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LowLevelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LowLevelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LowLevelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
