...
func NewHighLevelEntity(client *core.AcousticbrainzSDK, entopts map[string]any) *HighLevelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HighLevelEntity) GetName() string { return e.name }
...
func (e *HighLevelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HighLevelEntity) Deleted() bool {
	return e.deleted
}


func (e *HighLevelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHighLevelEntity(e.client, opts)
}

func (e *HighLevelEntity) Data(args ...any) any {
...
func (e *HighLevelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HighLevel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HighLevelEntity) DataTyped(data ...HighLevel) HighLevel {
	if len(data) > 0 {
		return typedFrom[HighLevel](e.Data(asMap(data[0])))
	}
	return typedFrom[HighLevel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HighLevel (all fields
// optional at the wire level).
func (e *HighLevelEntity) MatchTyped(match ...HighLevel) HighLevel {
	if len(match) > 0 {
		return typedFrom[HighLevel](e.Match(asMap(match[0])))
	}
	return typedFrom[HighLevel](e.Match())
}
...
func (e *HighLevelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HighLevelEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HighLevelLoadMatch and returns an HighLevel. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HighLevelEntity) LoadTyped(reqmatch HighLevelLoadMatch, ctrl map[string]any) (HighLevel, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return HighLevel{}, err
	}
	return typedFrom[HighLevel](res), nil
}



func (e *HighLevelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HighLevelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HighLevelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HighLevelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HighLevelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
