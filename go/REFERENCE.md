# Acousticbrainz Golang SDK Reference

Complete API reference for the Acousticbrainz Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *AcousticbrainzSDK`
...
#### `HighLevel(data map[string]any) AcousticbrainzEntity`

Create a new `HighLevel` entity instance. Pass `nil` for no initial data.

#### `LowLevel(data map[string]any) AcousticbrainzEntity`

Create a new `LowLevel` entity instance. Pass `nil` for no initial data.

#### `Metadata(data map[string]any) AcousticbrainzEntity`
