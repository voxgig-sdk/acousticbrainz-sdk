...
const testSeed = `map[string]any{"entity": map[string]any{"high_level": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "low_level": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
