...
describe("LowLevelDirect", function()
  it("should direct-load-low_level", function()
    local setup = low_level_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-low_level", setup.live and "live" or "unit")
...
function low_level_direct_setup(mockres)
