...
describe("HighLevelDirect", function()
  it("should direct-load-high_level", function()
    local setup = high_level_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-high_level", setup.live and "live" or "unit")
...
function high_level_direct_setup(mockres)
