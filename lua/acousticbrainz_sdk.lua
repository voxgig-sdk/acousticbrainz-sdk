...
local AcousticbrainzSDK = {}
AcousticbrainzSDK.__index = AcousticbrainzSDK
...
AcousticbrainzSDK._make_feature = _make_feature


function AcousticbrainzSDK.new(options)
  local self = setmetatable({}, AcousticbrainzSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AcousticbrainzSDK:options_map()
...
function AcousticbrainzSDK:get_utility()
  return Utility.copy(self._utility)
end


function AcousticbrainzSDK:get_root_ctx()
  return self._rootctx
end


function AcousticbrainzSDK:prepare(fetchargs)
...
function AcousticbrainzSDK:direct(fetchargs)
...
-- by passing it.
function AcousticbrainzSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AcousticbrainzSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "AcousticbrainzSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function AcousticbrainzSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AcousticbrainzSDK.new(sdkopts)
  sdk.mode = "test"
