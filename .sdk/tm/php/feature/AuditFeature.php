...
// Acousticbrainz SDK audit feature
...
class AcousticbrainzAuditFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _emit(AcousticbrainzContext $ctx, string $outcome): void
    {
