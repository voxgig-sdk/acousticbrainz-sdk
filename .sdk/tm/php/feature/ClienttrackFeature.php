...
// Acousticbrainz SDK clienttrack feature
...
class AcousticbrainzClienttrackFeature extends AcousticbrainzBaseFeature
{
    ...
    public function PostConstruct(AcousticbrainzContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Acousticbrainz-SDK';
