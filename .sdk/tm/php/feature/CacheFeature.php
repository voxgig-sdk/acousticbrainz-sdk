...
// Acousticbrainz SDK cache feature
...
class AcousticbrainzCacheFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _through(AcousticbrainzContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
