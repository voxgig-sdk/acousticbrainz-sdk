...
// Acousticbrainz SDK ratelimit feature
...
class AcousticbrainzRatelimitFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _acquire(AcousticbrainzContext $ctx): void
    {
    ...
    private function _track(AcousticbrainzContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
