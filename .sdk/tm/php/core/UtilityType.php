...
// Acousticbrainz SDK utility type

class AcousticbrainzUtility
{
    ...
    public static function copy(AcousticbrainzUtility $src): AcousticbrainzUtility
    {
        $u = new AcousticbrainzUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
