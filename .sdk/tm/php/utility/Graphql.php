...
// Acousticbrainz SDK utility: graphql
//
...
class AcousticbrainzGraphql
{
    ...
    // equivalent.
    public static function body(AcousticbrainzContext $ctx): mixed
    {
    ...
    public static function errors(AcousticbrainzContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
