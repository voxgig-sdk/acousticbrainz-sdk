...
|---|---|---|
| `ts/` | @voxgig-sdk/acousticbrainz-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/acousticbrainz-sdk \
      --repository voxgig-sdk/acousticbrainz-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/acousticbrainz-sdk` shows it, and
`npm trust revoke @voxgig-sdk/acousticbrainz-sdk --id=<id>` removes it.
