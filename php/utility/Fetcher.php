...
// Acousticbrainz SDK utility: fetcher
...
class AcousticbrainzFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AcousticbrainzSDK/1.0)';
    ...
    public static function call(AcousticbrainzContext $ctx, string $fullurl, array $fetchdef): array
    {
