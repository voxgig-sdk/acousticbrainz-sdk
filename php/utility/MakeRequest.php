...
// Acousticbrainz SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AcousticbrainzMakeRequest
{
    public static function call(AcousticbrainzContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AcousticbrainzResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AcousticbrainzResponse($fetched);
        } else {
