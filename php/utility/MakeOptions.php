...
// Acousticbrainz SDK utility: make_options

class AcousticbrainzMakeOptions
{
    ...
    public static function call(AcousticbrainzContext $ctx): array
    {
        ...
        //
        // `AcousticbrainzSchema::optspec()` is built from the model:
        ...
        $optspec = AcousticbrainzSchema::optspec();
