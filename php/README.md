# Acousticbrainz PHP SDK



The PHP SDK for the Acousticbrainz API — an entity-oriented client using PHP conventions.
...
```
php/
├── acousticbrainz_sdk.php          -- Main SDK class
...
The main class (`acousticbrainz_sdk.php`) exports the SDK class
