...
// Acousticbrainz SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AcousticbrainzSDK::test)
...
{
    private const SDK_CLASS = 'AcousticbrainzSDK';
    ...
    private const SDK_BASE = 'acousticbrainz_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../acousticbrainz_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
