...
class AcousticbrainzTestRunner
{
    ...
    {
        $live = self::getenv('ACOUSTICBRAINZ_TEST_LIVE');
        $override = self::getenv('ACOUSTICBRAINZ_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ACOUSTICBRAINZ_TEST_EXPLAIN');
...
class_alias('AcousticbrainzTestRunner', 'Runner');
class_alias('AcousticbrainzHelpers', 'Helpers');
