...
// Acousticbrainz SDK pipeline test
//
...
{
    private static function utility(): AcousticbrainzUtility
    {
        return new AcousticbrainzUtility();
    }
    ...
    private static function ctx(array $over = []): AcousticbrainzContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AcousticbrainzContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AcousticbrainzOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AcousticbrainzError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AcousticbrainzOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AcousticbrainzMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AcousticbrainzOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AcousticbrainzMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AcousticbrainzOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AcousticbrainzMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AcousticbrainzSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AcousticbrainzMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AcousticbrainzResponse([]),
            'result' => new AcousticbrainzResult([]),
        ]);
        [, $err] = AcousticbrainzMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AcousticbrainzSpec([]),
            'response' => null,
            'result' => new AcousticbrainzResult([]),
        ]);
        [, $err] = AcousticbrainzMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AcousticbrainzSpec(['step' => 's']),
            'response' => new AcousticbrainzResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AcousticbrainzResult([]),
        ]);
        [, $err] = AcousticbrainzMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AcousticbrainzSpec(['step' => 's']),
            'response' => new AcousticbrainzResponse(self::resp(200, ['v' => 1])),
            'result' => new AcousticbrainzResult([]),
        ]);
        [, $err] = AcousticbrainzMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AcousticbrainzSpec(['step' => 's']),
            'response' => new AcousticbrainzResponse(self::resp(200, ['v' => 2])),
            'result' => new AcousticbrainzResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AcousticbrainzMakeResponse::call($ctx);
    ...
    {
        $preset = new AcousticbrainzResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AcousticbrainzSpec([]),
            'response' => new AcousticbrainzResponse([]),
            'result' => new AcousticbrainzResult([]),
        ...
        [$got, $err] = AcousticbrainzMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AcousticbrainzResult([])]);
        [, $err] = AcousticbrainzMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AcousticbrainzSpec([]), 'result' => null]);
        [, $err] = AcousticbrainzMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AcousticbrainzSpec(['step' => 's']),
            'result' => new AcousticbrainzResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AcousticbrainzOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AcousticbrainzMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AcousticbrainzSpec(['step' => 's']),
            'result' => new AcousticbrainzResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AcousticbrainzOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AcousticbrainzMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AcousticbrainzResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AcousticbrainzSpec([]),
            'result' => new AcousticbrainzResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AcousticbrainzMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AcousticbrainzMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AcousticbrainzError('boom', 'boom');
        $utility->fetcher = function (AcousticbrainzContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AcousticbrainzSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AcousticbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AcousticbrainzContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AcousticbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AcousticbrainzResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AcousticbrainzMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AcousticbrainzContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AcousticbrainzSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AcousticbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AcousticbrainzResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AcousticbrainzSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AcousticbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AcousticbrainzMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AcousticbrainzMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AcousticbrainzResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AcousticbrainzDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AcousticbrainzResult(['ok' => false])]);
        $this->expectException(AcousticbrainzError::class);
        AcousticbrainzDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AcousticbrainzResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AcousticbrainzMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AcousticbrainzMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AcousticbrainzBaseFeature();
        $b = new AcousticbrainzBaseFeature();
        AcousticbrainzFeatureAdd::call($ctx, $a);
        AcousticbrainzFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AcousticbrainzBaseFeature
    {
        $f = new AcousticbrainzBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AcousticbrainzFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AcousticbrainzContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AcousticbrainzSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AcousticbrainzPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AcousticbrainzPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AcousticbrainzResponse(['headers' => null]),
            'result' => new AcousticbrainzResult([]),
        ]);
        AcousticbrainzResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AcousticbrainzResultBody::call($ctx);
