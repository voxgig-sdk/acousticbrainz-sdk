...
// Acousticbrainz SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AcousticbrainzOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AcousticbrainzOmni::structfix($now, Struct::undef()))
                        !== json_encode(AcousticbrainzOmni::structfix($val, Struct::undef()))) {
