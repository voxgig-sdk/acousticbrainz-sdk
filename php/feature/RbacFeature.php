...
// Acousticbrainz SDK rbac feature
...
class AcousticbrainzRbacFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _required(AcousticbrainzContext $ctx): ?string
    {
    ...
    private function _reject(AcousticbrainzContext $ctx, string $required): void
    {
    ...
    private function _track(AcousticbrainzContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
