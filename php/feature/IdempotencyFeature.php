...
// Acousticbrainz SDK idempotency feature
...
class AcousticbrainzIdempotencyFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _mutating(AcousticbrainzContext $ctx): bool
    {
