...
// Acousticbrainz SDK proxy feature
...
class AcousticbrainzProxyFeature extends AcousticbrainzBaseFeature
{
    ...
    public function init(AcousticbrainzContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AcousticbrainzContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
