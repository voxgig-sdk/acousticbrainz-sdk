...
// Acousticbrainz SDK timeout feature
...
class AcousticbrainzTimeoutFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _with_timeout(AcousticbrainzContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AcousticbrainzContext $_ctx, float $ms): void
    {
        $client = $this->client;
