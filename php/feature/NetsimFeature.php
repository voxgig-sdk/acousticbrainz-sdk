...
// Acousticbrainz SDK netsim feature
...
class AcousticbrainzNetsimFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _simulate(AcousticbrainzContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AcousticbrainzContext $ctx, array $applied): void
    {
        $client = $this->client;
