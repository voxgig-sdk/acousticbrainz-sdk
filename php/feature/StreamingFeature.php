...
// Acousticbrainz SDK streaming feature
...
class AcousticbrainzStreamingFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _iterate(AcousticbrainzResult $result): \Generator
    {
    ...
    private function _streamable(AcousticbrainzContext $ctx): bool
    {
