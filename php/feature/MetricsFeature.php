...
// Acousticbrainz SDK metrics feature
...
class AcousticbrainzMetricsFeature extends AcousticbrainzBaseFeature
{
    ...
    private function _record(AcousticbrainzContext $ctx, bool $ok): void
    {
