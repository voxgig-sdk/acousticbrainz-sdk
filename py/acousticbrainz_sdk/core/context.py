...
from acousticbrainz_sdk.core.helpers import get_ctx_prop, to_map
...
class AcousticbrainzContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AcousticbrainzControl()
        ...
        if isinstance(sp, AcousticbrainzSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AcousticbrainzResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AcousticbrainzResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AcousticbrainzOperation({})
    ...
    def make_error(self, code, msg):
        return AcousticbrainzError(code, msg, self)
