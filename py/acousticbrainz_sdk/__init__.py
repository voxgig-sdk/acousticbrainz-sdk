...
from acousticbrainz_sdk.utility import register

# Load features
from acousticbrainz_sdk.feature.base_feature import AcousticbrainzBaseFeature
from acousticbrainz_sdk.features import _has_feature, _make_feature
...
class AcousticbrainzSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AcousticbrainzUtility()
        self._utility = utility

        from acousticbrainz_sdk.config import shared_config
    ...
    def get_utility(self):
        return AcousticbrainzUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AcousticbrainzSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def HighLevel(self, data=None) -> "HighLevelEntity":
        ...
        from acousticbrainz_sdk.entity.high_level_entity import HighLevelEntity
    ...
    def LowLevel(self, data=None) -> "LowLevelEntity":
        ...
        from acousticbrainz_sdk.entity.low_level_entity import LowLevelEntity
    ...
    def Metadata(self, data=None) -> "MetadataEntity":
        ...
        from acousticbrainz_sdk.entity.metadata_entity import MetadataEntity
