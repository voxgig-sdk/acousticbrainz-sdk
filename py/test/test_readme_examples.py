# Acousticbrainz SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AcousticbrainzSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AcousticbrainzSDK(...) and AcousticbrainzSDK.test(...) become
#      AcousticbrainzSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "acousticbrainz_sdk"
_SDK_CLASS = "AcousticbrainzSDK"
