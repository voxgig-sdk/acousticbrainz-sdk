...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/acousticbrainz` | `npm install @voxgig-sdk/acousticbrainz` |
| Python | `voxgig-sdk-acousticbrainz` | `pip install voxgig-sdk-acousticbrainz` |
| PHP | `voxgig-sdk/acousticbrainz` | `composer require voxgig-sdk/acousticbrainz` |
| Golang | `github.com/voxgig-sdk/acousticbrainz-sdk/go` | `go get github.com/voxgig-sdk/acousticbrainz-sdk/go` |
| Ruby | `voxgig-sdk-acousticbrainz` | `gem install voxgig-sdk-acousticbrainz` |
| Lua | `voxgig-sdk-acousticbrainz` | `luarocks install voxgig-sdk-acousticbrainz` |
