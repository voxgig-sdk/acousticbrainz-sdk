...
function envOverride(m) {
    if ('TRUE' === process.env.ACOUSTICBRAINZ_TEST_LIVE ||
        'TRUE' === process.env.ACOUSTICBRAINZ_TEST_OVERRIDE) {
    ...
    m.ACOUSTICBRAINZ_TEST_EXPLAIN = process.env.ACOUSTICBRAINZ_TEST_EXPLAIN || m.ACOUSTICBRAINZ_TEST_EXPLAIN;
    return m;
}
