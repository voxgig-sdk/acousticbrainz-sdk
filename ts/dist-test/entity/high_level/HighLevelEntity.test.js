...
(0, node_test_1.describe)('HighLevelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'high_level.' + op, live))
                return;
        }
        ...
        let high_level_ref01_data = Object.values(setup.data.existing.high_level)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/high_level/HighLevelTestData.json');
    ...
    let idmap = transform(['high_level01', 'high_level02', 'high_level03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ACOUSTICBRAINZ_TEST_HIGH_LEVEL_ENTID'];
...
//# sourceMappingURL=HighLevelEntity.test.js.map