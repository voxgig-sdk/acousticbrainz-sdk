...
(0, node_test_1.describe)('LowLevelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AcousticbrainzSDK({
    ...
    (0, node_test_1.test)('direct-load-low_level', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-low_level', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ACOUSTICBRAINZ_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AcousticbrainzSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ACOUSTICBRAINZ_TEST_LOW_LEVEL_ENTID'];
    ...
    const client = new __1.AcousticbrainzSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LowLevelDirect.test.js.map