...
(0, node_test_1.describe)('LowLevelEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/low_level/LowLevelTestData.json');
    ...
    let idmap = transform(['low_level01', 'low_level02', 'low_level03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=LowLevelEntity.test.js.map