...
#      offline in seeded test mode (AcousticbrainzSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Acousticbrainz_sdk.rb")
  SDK_CLASS = "AcousticbrainzSDK"
