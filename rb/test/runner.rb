...
module AcousticbrainzTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("ACOUSTICBRAINZ_TEST_LIVE")
    override = getenv("ACOUSTICBRAINZ_TEST_OVERRIDE")
    ...
    explain = getenv("ACOUSTICBRAINZ_TEST_EXPLAIN")
    m["ACOUSTICBRAINZ_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AcousticbrainzTestRunner
Helpers = AcousticbrainzHelpers
Vs = VoxgigStruct
