// Command Acousticbrainz-mcp is an MCP server exposing the Acousticbrainz
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Acousticbrainz_list  — list records of an entity
//	Acousticbrainz_load  — load a single record of an entity
//
